    ...
    <div class="site-wrapper-inner clearfix">
        ...
        <div class="cover-container container">
            ...
            <div class="inner cover clearfix">
                ...
                <span id="typed"></span>
                    <h1 class="page-intro">Welcome to <span style="color: #337ab7;">Jobster</span> <span id="emoji"></span></h1>
                  ...
                  <p style="color: rgba(80, 144, 204, 0.9);">
                   Current Time: <a id="dynamicTime"></a><br/>
                   - <a target="_blank" href="/jobster/resources/Documentation/index.html">Read Project Documentation here</a>
                  </p>
                ...
                <div class="col-xs-12 col-sm-5 col-sm-offset-1 sign-in-outer">
                  ...
                  <h2 class="form-heading">Sign In</h2>
                    <form class="row" id="login-form" name='loginForm' action="<c:url value='/j_spring_security_check' />" method='POST' autocomplete="off">
                                <div class="input-group">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                <input tabindex="1" class="form-control input-lg" id="username-input" type="text" size="30" maxlength="45" name='username' title="username" placeholder="Enter Username" required="required">
                      </div>
                                <div class="input-group">
                                  <i class="fa fa-lock" aria-hidden="true"></i>
                      <input tabindex="1" class="form-control input-lg" id="password-input" name="password" type="password" size="30" maxlength="45" name='password' title="password" placeholder="Enter password" required="required">
                      </div>
